...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //setting up datpicker on edittext
...
//
//            // Date Picker Dialog
//            val picker = DatePickerDialog(requireContext(), { _, selectedYear, selectedMonth, selectedDayOfMonth ->
//                editTextRegisterDob.setText("$selectedDayOfMonth/${selectedMonth + 1}/$selectedYear")
//            }, year, month, day)
//            picker.show()
//        }
...
//                final Calandar calandar = Calandar.getInstance();
//                int day = calander.get(Calandar.DAY_OF_MONTH)
//                int month = calander.get(Calandar.MONTH)
//                int year = calander.get(Calandar.YEAR)
//
//                //Date Picker Dialog
